...
<div id="comments" class="comments-area">
	...
	?>
		<p class="no-comments"><?php esc_html_e( 'No se admiten comentarios en este post.', 'activello' ); ?></p>
	<?php endif; ?>
	...
	<?php comment_form(
		array(
			'fields' => $fields,
			'label_submit' => __( 'Dejar Comentario', 'activello' ),
			'comment_notes_before' => '',
			'comment_field' => '<textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" placeholder="'. esc_attr( _x( 'Comenta', 'comment form placeholder', 'activello' ) ).'"></textarea>',
		)
	); ?>
