	...
	<div class="blog-item-wrap">
		<div class="post-inner-content">
            ...
            <div class="entry-footer">
                ...
                <span class="comments-link"><?php comments_popup_link( esc_html__( 'Deja tu Comentario', 'activello' ), esc_html__( 'Comentario (1)', 'activello' ), esc_html__( 'Comentarios (%)', 'activello' ) ); ?></span>
                <?php endif; ?>	
                <?php if(has_tag()) : ?>
                <!-- tags -->
                <div class="tagcloud">
